...
<html lang="el">
	...
	<!-- begin::Body -->
	<body class="kt-page--fluid kt-page-content-white kt-subheader--enabled kt-subheader--transparent kt-page--loading">
			...
			<div class="kt-container">
				<div class="kt-footer__wrapper">
					<div class="kt-footer__copyright">
						2019&nbsp;&copy;&nbsp;<a href="https://dtek.gr/" target="_blank" class="kt-link">Dtek</a>
					</div>
				</div>
			</div>
		</div>
