            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('warehouses.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
...
@section('custom_script')
    ...
    <script src="{{ asset('assets/app/custom/warehouse/list.js') }}" type="text/javascript"></script>
@endsection