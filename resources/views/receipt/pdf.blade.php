        ...
        <tbody>
            <tr>
                ...
                <td style="text-align:right;">
                    <p style="font-size:20px;font-weight:bold;" class="m-0">ΑΠΟΔΕΙΞΗ - ΔΕΛΤΙΟ ΑΠΟΣΤΟΛΗΣ</p>
                    <p class="m-0" style="color:#666;font-weight:700;"></p>
                        <p style="color: orange;margin:0px;text-transform:uppercase;">Εκδοθηκε</p>
                </td>
            </tr>
                    ...
                    <table width="100%" class="table text-right">
                        ...
                        @endphp
                            ...
                            <tr class="tax-area">
                                ...
                                <td style="text-align:right;">{{ round($total_tax, 2) }} &euro;</td>
                            </tr>
