                                    ...
                                    <div class="col-md-12">
                                        <div class="pull-left">
                                            <h3 class="bold no-mtop invoice-html-number no-mbot">
                                              <span class="sticky-visible hide">Απόδειξη</span>
                                            </h3>
                            ...
                            <div class="col-md-10 col-md-offset-1">
                                <div class="row mtop20">
                                    <div class="col-md-6 col-sm-6 transaction-html-info-col-left">
                                      <h4 class="bold invoice-html-number">Απόδειξη</h4>
                                    ...
                                    <div class="col-sm-6 text-right transaction-html-info-col-right">
                                      ...
                                      <p class="no-mbot invoice-html-date">
                                          ...
                                          <span>Σκοπός Διακίνισης:</span>ΠΩΛΗΣΗ<br>
                                          <span>Τόπος Αποστολής</span>ΕΔΡΑ ΜΑΣ<br>
                                          <span>Τόπος Παράδοσης</span>ΕΔΡΑ ΤΟΥΣ<br>
                                        <span class="bold">Ημ/νία Έκδοσης:</span> {{ date('d-m-Y') }}
                                      </p>
                                            ...
                                            <table class="table items items-preview invoice-items-preview" data-type="invoice">
                                                ...
                                                @endphp
                                                    ...
                                                    <tr nobr="true">
                                                        ...
                                                        <td align="right">{{ round($p['price'], 2) }}&euro;</td>
                                    ...
                                    <div class="col-md-6 col-md-offset-6">
                                        <table class="table text-right">
                                            <tbody>
                                                ...
                                                @endphp
                                                <tr>
                                                    <td><span class="bold">Τύπος Έκπτωσης</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><span class="bold">Ποσό Έκπτωσης</span>
                                                    </td>
                                                ...
                                                @endphp
                                                <tr>
                                                    <td><span class="bold">Τελικό Σύνολο</span></td>
                                                    <td class="total">{{ round($total, 2) }} &euro; </td>
                                                </tr>
                                                <tr>
                                                    <td><span class="bold">Σχόλια</span></td>
                                                    <td><span class="">{{ $order['comments'] }}</span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
