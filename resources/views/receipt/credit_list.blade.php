...
@section('custom_script')
    ...
    <script src="{{ asset('assets/app/custom/invoice/credit_list.js') }}" type="text/javascript"></script>
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.cancel-invoice', function() {
                let credit_invoice_id = $(this).data('id');
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: BASE_URL + '/creditinvoices/' + credit_invoice_id,
                            method: 'POST',
                            data: {
                                _method: 'PUT',
                                credit_invoice_id,
