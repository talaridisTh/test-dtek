    ...
    <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('manufacturers.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
        ...
        <div class="kt-portlet__body">
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                <thead>
                    <tr>
                        <th>ID Κατασκευαστή</th>
                        <th>Όνομα Κατασκευαστή</th>
                        <th>Εικόνα</th>
                        <th>Ενέργειες</th>
                    </tr>
                </thead>
...
@section('custom_script')
    ...
    <script src="{{ asset('assets/app/custom/manufacturer/list.js') }}" type="text/javascript"></script>
@endsection