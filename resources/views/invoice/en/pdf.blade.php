        ...
        <tbody>
            <tr>
                ...
                <td style="text-align:right;">
                    <p style="width:400px;font-size:20px;font-weight:bold;" class="m-0">INVOICE</p>
                    <p class="m-0" style="color:#666;font-weight:700;">#INV-{{$invoice['invoice_id']}}</p>
                    @if (true)
                        <p style="color: red;margin:0px;text-transform:uppercase;">Not Paid</p>
                    @else
                        <p style="color: green;margin:0px;text-transform:uppercase;">Paid</p>
                    @endif
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <address class="invoice-html-company-info">
                        ...
                        <br>{{ $store_info['profession'] }}<br>TEL {{ $store_info['phone'] }}  FAX {{ $store_info['fax'] }}
                        <br>{{$store_info['address']}}<br>{{$store_info['city']}}<br>
                        <br>EMAIL: {{ $store_info['email'] }}
                        <br>TAX ID {{ $store_info['afm'] }} - TAX OFFICE {{ $store_info['doy'] }}
                    ...
                    <p class="no-mbot invoice-html-date">
                        @php
                            ...
                            if($order->payment_type == 2)
                                $payment_text='Cash Check';
                            if($order->payment_type == 3)
                                $payment_text='Credit card';
                            if($order->payment_type == 4)
                                $payment_text='Pay on delivery';
                            if($order->payment_type == 5)
                                $payment_text='By bank deposit';
                            if($order->payment_type == 6)
                                $payment_text='Paypal';
                        @endphp
                        <span>Payment Method: </span>{{ $payment_text }}<br>
                        <span>Purpose of movement: </span>SALE<br>
                        <span>Shipping location: </span>OUR HEAD OFFICE<br>
                        <span>Delivery location: </span>THEIR HEAD OFFICE<br>
                    ...
                    <table style="width:100%;border: none;" cellspacing="0" cellpadding="0">
                        <thead style="width:100%;">
                            <tr style="width:100%;color:white;background-color:#415164;">
                                ...
                                <th style="font-weight:normal;height:30px;border:none;text-align:right;">Price</th>
                                <th style="font-weight:normal;height:30px;border:none;text-align:right;">Pre-Discount Value</th>
                                <th style="font-weight:normal;height:30px;border:none;text-align:right;">Discount<br> % | Αmount</th>
                                <th style="font-weight:normal;height:30px;border:none;text-align:right;padding-right:10px;">Total Price</th>
                            </tr>
                        </thead>
                        <tbody style="width:100%;">
                            ...
                            <tr style="width:100%;height:30px;border-bottom:1px solid #ccc;">
                                ...
                                <td style="height:30px;text-align:left;" class="description">
                                    <span style="font-size:12px;">Enviromental Tax</span>
                                </td>
                ...
                <td style="text-align:right;border:none;">
                    <table width="100%" class="table text-right">
                        <tbody style="margin-right:0px;padding-right:0px;">
                            ...
                            @endphp
                            <tr>
                                <td style="text-align:right;"><span class="bold">Discount Type</span></td>
                                <td style="text-align:right;" class="total">{{ $order['discount_type'] == 1 ? 'Percentage' : 'Σταθερό ποσό' }} ({!! $order['discount_type'] == 1 ? $order['discount_amount'].'%' : $order['discount_amount'].'&euro;' !!})</td>
                            </tr>
                            <tr>
                                <td style="text-align:right;"><span class="bold">Discount Price</span></td>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:left;vertical-align:top;width:200px;">
                                    <span class="bold">Bank accounts:</span><br>
                                    <br><span style="font-size:10px;">National Bank: GR75 0110 2510 0000 2510 0173 456</span>
                                    <br><span style="font-size:10px;">Eurobank : GR7102607030000680200273475</span>
                                    <br><span style="font-size:10px;">Piraeus Bank: GR70 0172 2030 0052 0309 4292 227</span>
                                ...
                                <td width="100px;" style="text-align:center;vertical-align:top;height:200px;">
                                    <span class="bold" style="text-decoration:underline;">Issue</span>
                                </td>
                                <td width="100px;" style="text-align:right;vertical-align:top;height:200px;">
                                    <span class="bold" style="text-decoration:underline;">Delivered</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
